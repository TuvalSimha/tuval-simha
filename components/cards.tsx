...
export function Cards() {
    return (
        <div className="flex gap-8 flex-wrap justify-center mb-[100px] mt-[100px]">
            {cards.map((card) => (
                <a href={card.href} key={card.href} className={` ${card.backgroundColor} cursor-pointer transform rounded-xl h-40 w-40 sm:h-64 sm:w-64 shadow-xl transition duration-300 hover:scale-105`}>
