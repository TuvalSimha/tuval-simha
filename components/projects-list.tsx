...
export const ProjectsUpdates = (props: { projects: Project[] }): ReactElement => {
    return (
        <>
            <Title title="Projects" description="I build projects to learn and to help others learn." />
...
export const getStaticProps: GetStaticProps<{ ssg: { projects: Project[] } }> = async () => {
